...
Bu dosya, ansiklopedi nişlere göre yeniden düzenlenmeden önce sekiz cildin sonunda biriken
sentez bölümlerini korur. Tek tek vakalardan değil, **vaka gruplarının tamamından** çıkan
derslerdir; bu yüzden tek bir nişin altına konamazlar.

Vakaların kendisi için `../ENCYCLOPEDIA.md` üzerinden niş dosyalarına gidin.
